...
export default function LoginForm({ next = '/dashboard' }: LoginFormProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { error } = await sendMagicLink(email.trim(), next)
        ...
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-base">
              ...
              Revisa tu bandeja de entrada para continuar donde te quedaste.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Ingresa tu correo para recibir un enlace mágico y continuar tu trabajo.
          </CardDescription>
        </CardHeader>
        <CardContent>
